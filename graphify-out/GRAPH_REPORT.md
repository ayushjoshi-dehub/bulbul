...
## Corpus Check
- 74 files · ~47,400 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 361 nodes · 536 edges · 26 communities (21 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1f60e0df`
...
Cohesion: 0.08
Nodes (28): acceptFriendRequest(), getConversationsForSidebar(), getMessages(), getUsersForSidebar(), sendFriendRequest(), sendMessage(), job, createFilename() (+20 more)
...
Cohesion: 0.06
Nodes (35): dependencies, axios, @clerk/clerk-react, @heroui/react, lucide-react, react, react-dom, react-hot-toast (+27 more)
...
Cohesion: 0.15
Nodes (17): buildFallbackEmail(), buildFallbackProfile(), buildUsername(), checkAuth(), createUniqueUsername(), getClerkUserProfile(), resolveEmail(), syncAllClerkUsers() (+9 more)
...
Cohesion: 0.25
Nodes (7): dependencies, svix, devDependencies, eslint-plugin-react-dom, eslint-plugin-react-x, @typescript-eslint/eslint-plugin, @typescript-eslint/parser
